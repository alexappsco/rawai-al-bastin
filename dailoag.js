...
//                     btn.classList.remove('border-[rgba(10,109,102,1)]', 'bg-[rgba(10,109,102,0.05)]');
//                     btn.classList.add('border-gray-100');
//                 });
//                 el.classList.add('border-[rgba(10,109,102,1)]', 'bg-[rgba(10,109,102,0.05)]');
...
//         // إخفاء الأول تماماً وإظهار الثاني
//         step1Content.classList.replace('block', 'hidden');
//         step2Content.classList.remove('hidden');
        
//         // تحديث حالة الـ Stepper
//         document.getElementById('line1').classList.replace(
//         'bg-gray-200',
//         'bg-[rgba(179,210,52,1)]'
//         );
//         const step2Icon = document.getElementById('step2-icon');
//         step2Icon.classList.remove('bg-[rgba(230,244,244,1)]', 'text-gray-400', 'border-gray-200');
//         step2Icon.classList.add('bg-[rgba(179,210,52,1)]', 'text-white', 'border-[rgba(10,109,102,1)]');
//         step2Icon.nextElementSibling.classList.replace('text-gray-400', 'text-[rgba(10,109,102,1)]');
//     });
...
//             // إعادة حالة الـ Stepper للرمادي
//             document.getElementById('line1').classList.replace('bg-[rgba(179,210,52,1)]', 'bg-gray-200');
//             const step2Icon = document.getElementById('step2-icon');
//             step2Icon.classList.add('bg-[rgba(230,244,244,1)]', 'text-gray-400', 'border-gray-200');
//             step2Icon.classList.remove('bg-[rgba(179,210,52,1)]', 'text-white', 'border-[rgba(10,109,102,1)]');
//         });
//     }
// });
// // تعريف العناصر
...
// // أيقونات الحالة في الأعلى (بناءً على الـ IDs في الكود الخاص بك)
// const step3Icon = document.getElementById('step3-icon'); // تأكد من تسمية الأيقونة الثالثة بهذا الاسم
// const line2 = document.getElementById('line2');

// // من الخطوة 2 إلى الخطوة 3
// nextToStep3.addEventListener('click', () => {
//     step2Content.classList.add('hidden');
//     step3Content.classList.remove('hidden');
    
//     // تحديث شكل الأيقونة الثالثة والخط الواصل
//     step3Icon.classList.remove('bg-[rgba(230,244,244,1)]', 'text-gray-400');
//     step3Icon.classList.add('bg-[rgba(179,210,52,1)]', 'text-white', 'border-[rgba(10,109,102,1)]');
//     line2.classList.replace('bg-gray-200', 'bg-[rgba(179,210,52,1)]');
// });

// // العودة من الخطوة 3 إلى الخطوة 2
// backToStep2.addEventListener('click', () => {
//     step3Content.classList.add('hidden');
//     step2Content.classList.remove('hidden');
    
//     // إعادة شكل الأيقونة الثالثة والخط للوضع السابق
//     step3Icon.classList.add('bg-[rgba(230,244,244,1)]', 'text-gray-400');
//     step3Icon.classList.remove('bg-[rgba(179,210,52,1)]', 'text-white', 'border-[rgba(10,109,102,1)]');
//     line2.classList.replace('bg-[rgba(179,210,52,1)]', 'bg-gray-200');
// });
...
// // 2. وظيفة تفتح مودال النجاح (يتم استدعاؤها عند الضغط على إرسال)
// function openSuccessModal() {
//     // إغلاق مودال الطلب الحالي
